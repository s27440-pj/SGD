    ...
    for i in range(3): # do the flash 3 times
        for start, end, step in ((0, 255, 1), (255, 0, -1)):
            ...
            for alpha in range(start, end, animationSpeed * step): # animation loop
                ...
                # napis game over
                textSurf = GAME_OVER_FONT.render('Game Over', True, (255, 0, 0))  # czerwony tekst
                textRect = textSurf.get_rect(center=(DISPLAYSURF.get_width() // 2, DISPLAYSURF.get_height() // 2))
