...
def main():
    global FPSCLOCK, DISPLAYSURF, BASICFONT, L_SQUIR_IMG, R_SQUIR_IMG, GRASSIMAGES, FPS
...
def runGame():
    ...
    lvlUpSurf = BASICFONT.render('Level Up!', True, WHITE)
    lvlUpRect = lvlUpSurf.get_rect()
    lvlUpRect.center = (HALF_WINWIDTH, 20)
    ...
    while True: # main game loop
                ...
                if 'rect' in sqObj and playerObj['rect'].colliderect(sqObj['rect']):
                    ...
                    if sqObj['width'] * sqObj['height'] <= playerObj['size']**2:
                        ...
                        if playerObj['size'] % 5 == 0:
                            ...
                            DISPLAYSURF.blit(lvlUpSurf, lvlUpRect)
                        del squirrelObjs[i]
        ...
        if win_display_time is not None:
            if pygame.time.get_ticks() - win_display_time < 1000:
                DISPLAYSURF.blit(lvlUpSurf, lvlUpRect)
            else:
                win_display_time = None
