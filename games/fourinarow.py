...
def runGame(isFirstGame):
    ...
    humanTurn = BASICFONT.render('Human turn', True, WHITE)
    humanRect = humanTurn.get_rect()
    humanRect.center = (WINDOWWIDTH/2, 20)

    computerTurn = BASICFONT.render('Computer turn', True, WHITE)
    computerRect = computerTurn.get_rect()
    computerRect.center = (WINDOWWIDTH / 2, 20)
    ...
    while True: # main game loop
        if turn == HUMAN:
            # Human player's turn.
            DISPLAYSURF.blit(humanTurn, humanRect)
            ...
            DISPLAYSURF.blit(computerTurn, computerRect)
            pygame.display.update()
